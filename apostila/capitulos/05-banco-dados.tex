...
O bloco de \textbf{administração física} da ALERO 2026 (B+ Tree, índice
\emph{clustered}, hashing extensível, ARIES/WAL, otimizador e estatísticas,
tablespaces, \emph{connection pooling}, XML Schema, backup) está creditado no
Capítulo \ref{cap:orfaos} --- é o mesmo corpus, sob o rótulo de órfãs.
