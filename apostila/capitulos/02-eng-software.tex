...
nível; níveis de teste + TDD; ágil híbrido; CMMI por estágios (nível 3 =
Definido) e MPS.BR; modelo V (requisitos $\leftrightarrow$ aceitação,
arquitetural $\leftrightarrow$ integração); tipos de manutenção (adaptativa na
troca de SGBD); cobertura de comandos $\times$ decisões; estresse $\times$
carga; os três compromissos do Scrum. Rode \texttt{./quiz.py eng-software}.
\end{jacaiu}
