...
\textit{her}; conector \textit{thus} (efeito); \textit{and} $\approx$
\textit{moreover}; \textit{should} (sugestão); \textit{browse}/\textit{rate}
como verbo $\times$ substantivo; referência de \textit{it} (impressora). Rode
\texttt{./quiz.py ingles}.
\end{jacaiu}
