...
\begin{jacaiu}
\textbf{Em prova real da FGV:} análise sintática de frase curta (``É preciso
estar atento e forte''); adjunto adnominal; regência verbal; concordância
nominal; interpretação de verso (Fernando Pessoa, Luiz Gonzaga);
justificativa da vírgula; discurso direto --- \textbf{Dataprev 2024}
(Q1--Q12). Pleonasmo em reescrita; reescrever \emph{mudando} ou
\emph{mantendo} o sentido; processos de coesão para evitar repetição;
referência de termo de ligação; oração adjetiva trocada por termo
equivalente; apassivação; \textbf{colocação pronominal} (``Dê-me'' $\times$
``Me dá''); \textbf{regência de \emph{assistir}} --- \textbf{MPU}. Português
é o maior bloco de todas as provas do corpus (67 questões reais entre
Dataprev, MPU e TJ-RJ) e é sempre \textbf{interpretação + gramática
aplicada}.

\textbf{No nosso banco} (previsto pelo edital, ainda não visto na amostra de
provas): crase; concordância \emph{verbal} dos impessoais; \emph{por
que}/\emph{porque}/\emph{por quê}/\emph{porquê}; conjunção concessiva
substituível (``embora'' $\to$ ``ainda que'').

Rode \texttt{./quiz.py portugues}.
\end{jacaiu}
