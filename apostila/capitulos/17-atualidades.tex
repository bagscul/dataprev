...
prioritário/não) e se há \textbf{direito a explicação/revisão} da decisão
automatizada (art.\ 20 da LGPD --- ver Capítulo \ref{cap:legislacao}: a lei
garante revisão, \textbf{não} exige explicitamente que seja humana).
...
\begin{itemize}
\item O cenário descreve um sistema que \textbf{decide sozinho, sem nenhum
mecanismo de revisão}, e a alternativa correta chama isso de boa prática ---
\textbf{descarte}: LGPD garante revisão de decisão automatizada relevante
(art.\ 20). Cuidado para não superestimar a garantia: a lei \textbf{não}
exige explicitamente revisor \textbf{humano} (o trecho ``por pessoa
natural'' foi vetado --- ver Capítulo \ref{cap:legislacao}) --- diferente
do GDPR europeu. Uma alternativa que cobre isso como ``a LGPD garante
revisão humana'', sem ressalva, também é uma armadilha.
...
trade-off, conceito diferente); \textbf{direito à revisão} da LGPD,
art.\ 20 (sem exigir revisor humano --- ver Capítulo \ref{cap:legislacao})
--- a explicabilidade do art.\ 20 caiu, mas no bloco de
