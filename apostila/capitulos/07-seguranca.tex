...
\section{OWASP Top 10 --- 2021 e 2025 (leia os dois)}

O edital aponta para o projeto OWASP sem fixar ano. A Dataprev 2024 cobrou o
\textbf{2021}; o \textbf{2025} saiu em novembro de 2025. Saber os dois cobre
qualquer recorte que a prova use.

\begin{center}
\begin{tabular}{@{}p{1.3cm}p{5.3cm}p{5.3cm}@{}}
\toprule
\# & \textbf{Top 10:2021} & \textbf{Top 10:2025} \\
\midrule
1 & Broken Access Control & Broken Access Control (absorveu SSRF) \\
2 & Cryptographic Failures & Security Misconfiguration (subiu de 5º) \\
3 & Injection (SQLi; \textbf{XSS absorvido aqui}) & Software Supply Chain Failures (novo) \\
4 & Insecure Design (novo em 2021) & Cryptographic Failures (caiu para 4º) \\
5 & Security Misconfiguration & Injection (caiu para 5º) \\
6 & Vulnerable and Outdated Components & --- \\
7 & Identification and Authentication Failures & --- \\
8 & Software and Data Integrity Failures & --- \\
9 & Security Logging and Monitoring Failures & --- \\
10 & Server-Side Request Forgery (SSRF) & Mishandling of Exceptional Conditions (novo) \\
\bottomrule
\end{tabular}
\end{center}
...
engenharia'', ``treinamento operacional'' são de CI/CD e SSDF, não OWASP. Se
a prova disser ``2025'', troque o ranking conforme a tabela acima.
\end{pegadinha}
...
\begin{jacaiu}
Controle de acesso mandatório (rótulos); OWASP Top 10:2021 (identificar
categoria válida); X.800 mecanismos de segurança (específicos $\times$
disseminados); SSL $\times$ TLS; tríade CIA; IDS $\times$ IPS; SAST $\times$
DAST; modelo de responsabilidade compartilhada em nuvem; HMAC em webhook
(autenticidade + integridade). Rode \texttt{./quiz.py seguranca}.
\end{jacaiu}
