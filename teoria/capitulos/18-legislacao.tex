...
segredos comercial e industrial}. Se o controlador se recusar a informar
invocando esse segredo, a \textbf{ANPD pode realizar auditoria} para
verificar \textbf{aspectos discriminatórios} (§2º) --- o sigilo protege o
controlador do titular curioso, não da autoridade fiscalizadora.
...
A lei ainda abre um atalho para o caso mais comum de dano concreto ao
titular: em caso de \textbf{vazamento}, o \textbf{§7º} admite
\textbf{conciliação direta} entre controlador e titular --- e só na
\textbf{ausência de acordo} é que se aplicam as penalidades administrativas
do capítulo. É uma via alternativa ao processo sancionatório completo,
pensada para resolver o dano individual sem precisar esgotar o rito do
art.\ 52.
\end{conceito}
...
A transformação institucional de 2026 não veio no vácuo. A \textbf{Lei
15.211/2025}, o Estatuto Digital da Criança e do Adolescente (``ECA
Digital''), em vigor desde \textbf{17/03/2026}, atribuiu à ANPD a
competência de \textbf{regulamentar e fiscalizar} as obrigações impostas
às plataformas digitais quanto a crianças e adolescentes --- e foi esse
encargo novo, mais amplo que a fiscalização setorial original de proteção
de dados, que motivou dotar a autoridade de estrutura de \textbf{agência
reguladora} (mais autonomia e recursos do que um órgão comum tem).

Essa lei \textbf{não está no rol do edital do Perfil 3} (que cita LGPD,
Marco Civil, LAI e delitos informáticos) --- entra aqui só como pano de
fundo para explicar a mudança institucional da ANPD, não é matéria a
aprofundar.
\end{conceito}
...
Conteúdo íntimo não consentido (art.\ 21) & já bastava notificação
(exceção histórica) & continua bastando notificação (a exceção virou a
regra geral) \\
