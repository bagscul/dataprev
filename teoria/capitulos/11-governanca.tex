...
\begin{regrapratica}[O quarteto prático --- aceitar, mitigar, transferir, evitar]
Depois de avaliado, todo risco recebe uma destas respostas, no vocabulário
mais comum de gestão de projetos (PMBOK) e do senso prático de mercado:
\textbf{aceitar} (o custo de tratar é maior que o impacto do risco);
\textbf{mitigar} (reduzir probabilidade ou impacto com uma ação concreta);
\textbf{transferir} (repassar o impacto financeiro a terceiro, como um
seguro ou contrato); \textbf{evitar} (eliminar a atividade que gera o
risco). Não existe a opção de “ignorar sem decidir” --- mesmo não fazer
nada é, na prática, uma decisão de aceitar.
\end{regrapratica}

\begin{cuidado}[O texto literal da ISO 31000 é mais granular --- e inclui risco positivo]
O quarteto acima é um resumo prático, não a lista textual da norma. A ISO
31000:2018 (cláusula 6.5.2) descreve \textbf{sete} opções de tratamento,
mais detalhadas: evitar o risco; \textbf{assumir ou aumentar} o risco para
perseguir uma \textbf{oportunidade}; remover a fonte do risco; alterar a
probabilidade; alterar as consequências; compartilhar o risco (contrato,
seguro); e reter o risco por decisão informada. O ponto que mais diferencia
a norma do resumo popular: a ISO 31000 trata risco como o \textbf{efeito da
incerteza sobre objetivos} --- que pode ser negativo (ameaça) \textbf{ou
positivo} (oportunidade) --- por isso a norma prevê explicitamente
\textbf{assumir/aumentar} o risco quando ele representa uma chance boa, não
só respostas defensivas. Se uma questão cobrar a norma ao pé da letra (não
o resumo de mercado), desconfie de alternativas que tratam risco só como
ameaça.
\end{cuidado}
