...
sistema que decide \textbf{sozinho}, sem \textbf{nenhum} mecanismo de
revisão disponível ao titular, contraria essa garantia.
\end{conceito}

\begin{cuidado}[A lei garante revisão --- não garante explicitamente que seja \emph{humana}]
A redação original de 2018 previa revisão \textbf{“por pessoa natural”}.
Essa expressão foi \textbf{retirada} pela Lei 13.853/2019, e o parágrafo
que a reintroduziria (o §3º do art.\ 20) foi \textbf{vetado} --- veto
\textbf{mantido} pelo Congresso. Hoje o texto vigente garante apenas
“revisão” da decisão, \textbf{sem} exigir explicitamente que um humano a
conduza --- diferente do art.\ 22 do GDPR europeu, que garante intervenção
humana de forma expressa. Uma alternativa que descreva a LGPD como
equivalente ao GDPR nesse ponto específico (“garante revisão humana”, sem
ressalva) superestima a proteção do texto brasileiro vigente --- é a
armadilha mais provável deste artigo, porque a leitura intuitiva (e a
comparação automática com o GDPR) sugere humano, mas o texto vetado diz o
contrário.
\end{cuidado}
...
\textbf{direito a explicação/revisão} da decisão (art.\ 20 da LGPD --- sem
exigir explicitamente revisor humano, ver cuidado acima).
